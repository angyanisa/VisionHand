...
lines = [
    ...
    '      <geometry><mesh filename="meshes/palm.stl"/></geometry>',
...
for fn, wig_lim, curl_lim, reversed_curl in configs:
    ...
    lines.extend([
        ...
        f'      <geometry><mesh filename="meshes/{knuckle_file}"/></geometry>',
        ...
        f'      <geometry><mesh filename="meshes/{mid_file}"/></geometry>',
        ...
        f'      <geometry><mesh filename="meshes/{tip_file}"/></geometry>',
