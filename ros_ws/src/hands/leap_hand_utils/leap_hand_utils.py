...
def angle_safety_clip(joints, type = "regular"):
    sim_min, sim_max = LEAPsim_limits(type = type)
...
def LEAPsim_limits(type = "regular"):
    if type == "regular":
        sim_min = np.array([-1.047, -0.314, -0.506, -0.366, 
                            -1.047, -0.314, -0.506, -0.366, 
                            -1.047, -0.314, -0.506, -0.366, 
                            -0.349, -0.47, -1.20, -1.34])
        sim_max = np.array([1.047,    2.23,  1.885,  2.042,  
                            1.047,   2.23,  1.885,  2.042,  
                            1.047,   2.23,  1.885,  2.042,  
                            2.094,  2.443, 1.90,  1.88])
        
    elif type == "modified":
        # hardware limits minus 180 degrees (accounts for allegro to leap offset)
        sim_min = np.array([
            -1.047, -1.570, 0.000, 0.000, # Index
            -1.047, -1.570, 0.000, 0.000, # Middle
            -1.047, -1.570, 0.000, 0.000, # Ring
            0.000, 0.000, 0.000, 0.000  # Thumb
        ])
        sim_max = np.array([0.785, 0.000, 1.570, 1.570, 
                            0.785, 0.000, 1.570, 1.570, 
                            0.785, 0.000, 1.570, 1.570, 
